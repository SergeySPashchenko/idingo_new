...
void main() {
	...
	`}class vv extends ji{constructor(e=1,i={}){super(e,e,i),this.isWebGLCubeRenderTarget=!0;const r={width:e,height:e,depth:1},l=[r,r,r,r,r,r];this.texture=new fv(l),this._setTextureOptions(i),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,i){this.texture.type=i.type,this.texture.colorSpace=i.colorSpace,this.texture.generateMipmaps=i.generateMipmaps,this.texture.minFilter=i.minFilter,this.texture.magFilter=i.magFilter;const r={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},l=new Qo(5,5,5),c=new qi({name:"CubemapFromEquirect",uniforms:Fs(r.uniforms),vertexShader:r.vertexShader,fragmentShader:r.fragmentShader,side:Xn,blending:_a});c.uniforms.tEquirect.value=i;const d=new xi(l,c),p=i.minFilter;return i.minFilter===Ur&&(i.minFilter=Dn),new ab(1,10,this).update(e,d),i.minFilter=p,d.geometry.dispose(),d.material.dispose(),this}clear(e,i=!0,r=!0,l=!0){const c=e.getRenderTarget();for(let d=0;d<6;d++)e.setRenderTarget(this,d),e.clear(i,r,l);e.setRenderTarget(c)}}function J1(s){let e=new WeakMap,i=new WeakMap,r=null;function l(v,M=!1){return v==null?null:M?d(v):c(v)}function c(v){if(v&&v.isTexture){const M=v.mapping;if(M===od||M===ld)if(e.has(v)){const T=e.get(v).texture;return p(T,v.mapping)}else{const T=v.image;if(T&&T.height>0){const C=new vv(T.height);return C.fromEquirectangularTexture(s,v),e.set(v,C),v.addEventListener("dispose",h),p(C.texture,v.mapping)}else return null}}return v}function d(v){if(v&&v.isTexture){const M=v.mapping,T=M===od||M===ld,C=M===Nr||M===Os;if(T||C){let b=i.get(v);const S=b!==void 0?b.texture.pmremVersion:0;if(v.isRenderTargetTexture&&v.pmremVersion!==S)return r===null&&(r=new vx(s)),b=T?r.fromEquirectangular(v,b):r.fromCubemap(v,b),b.texture.pmremVersion=v.pmremVersion,i.set(v,b),b.texture;if(b!==void 0)return b.texture;{const D=v.image;return T&&D&&D.height>0||C&&D&&m(D)?(r===null&&(r=new vx(s)),b=T?r.fromEquirectangular(v):r.fromCubemap(v),b.texture.pmremVersion=v.pmremVersion,i.set(v,b),v.addEventListener("dispose",g),b.texture):null}}}return v}function p(v,M){return M===od?v.mapping=Nr:M===ld&&(v.mapping=Os),v}function m(v){let M=0;const T=6;for(let C=0;C<T;C++)v[C]!==void 0&&M++;return M===T}function h(v){const M=v.target;M.removeEventListener("dispose",h);const T=e.get(M);T!==void 0&&(e.delete(M),T.dispose())}function g(v){const M=v.target;M.removeEventListener("dispose",g);const T=i.get(M);T!==void 0&&(i.delete(M),T.dispose())}function _(){e=new WeakMap,i=new WeakMap,r!==null&&(r.dispose(),r=null)}return{get:l,dispose:_}}function $1(s){const e={};function i(r){if(e[r]!==void 0)return e[r];const l=s.getExtension(r);return e[r]=l,l}return{has:function(r){return i(r)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(r){const l=i(r);return l===null&&kc("WebGLRenderer: "+r+" extension not supported."),l}}}function eE(s,e,i,r){const l={},c=new WeakMap;function d(_){const v=_.target;v.index!==null&&e.remove(v.index);for(const T in v.attributes)e.remove(v.attributes[T]);v.removeEventListener("dispose",d),delete l[v.id];const M=c.get(v);M&&(e.remove(M),c.delete(v)),r.releaseStatesOfGeometry(v),v.isInstancedBufferGeometry===!0&&delete v._maxInstanceCount,i.memory.geometries--}function p(_,v){return l[v.id]===!0||(v.addEventListener("dispose",d),l[v.id]=!0,i.memory.geometries++),v}function m(_){const v=_.attributes;for(const M in v)e.update(v[M],s.ARRAY_BUFFER)}function h(_){const v=[],M=_.index,T=_.attributes.position;let C=0;if(T===void 0)return;if(M!==null){const D=M.array;C=M.version;for(let P=0,L=D.length;P<L;P+=3){const H=D[P+0],F=D[P+1],B=D[P+2];v.push(H,F,F,B,B,H)}}else{const D=T.array;C=T.version;for(let P=0,L=D.length/3-1;P<L;P+=3){const H=P+0,F=P+1,B=P+2;v.push(H,F,F,B,B,H)}}const b=new(T.count>=65535?lv:ov)(v,1);b.version=C;const S=c.get(_);S&&e.remove(S),c.set(_,b)}function g(_){const v=c.get(_);if(v){const M=_.index;M!==null&&v.version<M.version&&h(_)}else h(_);return c.get(_)}return{get:p,update:m,getWireframeAttribute:g}}function tE(s,e,i){let r;function l(v){r=v}let c,d;function p(v){c=v.type,d=v.bytesPerElement}function m(v,M){s.drawElements(r,M,c,v*d),i.update(M,r,1)}function h(v,M,T){T!==0&&(s.drawElementsInstanced(r,M,c,v*d,T),i.update(M,r,T))}function g(v,M,T){if(T===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(r,M,0,c,v,0,T);let b=0;for(let S=0;S<T;S++)b+=M[S];i.update(b,r,1)}function _(v,M,T,C){if(T===0)return;const b=e.get("WEBGL_multi_draw");if(b===null)for(let S=0;S<v.length;S++)h(v[S]/d,M[S],C[S]);else{b.multiDrawElementsInstancedWEBGL(r,M,0,c,v,0,C,0,T);let S=0;for(let D=0;D<T;D++)S+=M[D]*C[D];i.update(S,r,1)}}this.setMode=l,this.setIndex=p,this.render=m,this.renderInstances=h,this.renderMultiDraw=g,this.renderMultiDrawInstances=_}function nE(s){const e={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function r(c,d,p){switch(i.calls++,d){case s.TRIANGLES:i.triangles+=p*(c/3);break;case s.LINES:i.lines+=p*(c/2);break;case s.LINE_STRIP:i.lines+=p*(c-1);break;case s.LINE_LOOP:i.lines+=p*c;break;case s.POINTS:i.points+=p*c;break;default:Ut("WebGLInfo: Unknown draw mode:",d);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:e,render:i,programs:null,autoReset:!0,reset:l,update:r}}function iE(s,e,i){const r=new WeakMap,l=new tn;function c(d,p,m){const h=d.morphTargetInfluences,g=p.morphAttributes.position||p.morphAttributes.normal||p.morphAttributes.color,_=g!==void 0?g.length:0;let v=r.get(p);if(v===void 0||v.count!==_){let ue=function(){A.dispose(),r.delete(p),p.removeEventListener("dispose",ue)};var M=ue;v!==void 0&&v.texture.dispose();const T=p.morphAttributes.position!==void 0,C=p.morphAttributes.normal!==void 0,b=p.morphAttributes.color!==void 0,S=p.morphAttributes.position||[],D=p.morphAttributes.normal||[],P=p.morphAttributes.color||[];let L=0;T===!0&&(L=1),C===!0&&(L=2),b===!0&&(L=3);let H=p.attributes.position.count*L,F=1;H>e.maxTextureSize&&(F=Math.ceil(H/e.maxTextureSize),H=e.maxTextureSize);const B=new Float32Array(H*F*4*_),A=new av(B,H,F,_);A.type=Gi,A.needsUpdate=!0;const U=L*4;for(let V=0;V<_;V++){const Z=S[V],J=D[V],se=P[V],Q=H*F*4*V;for(let N=0;N<Z.count;N++){const I=N*U;T===!0&&(l.fromBufferAttribute(Z,N),B[Q+I+0]=l.x,B[Q+I+1]=l.y,B[Q+I+2]=l.z,B[Q+I+3]=0),C===!0&&(l.fromBufferAttribute(J,N),B[Q+I+4]=l.x,B[Q+I+5]=l.y,B[Q+I+6]=l.z,B[Q+I+7]=0),b===!0&&(l.fromBufferAttribute(se,N),B[Q+I+8]=l.x,B[Q+I+9]=l.y,B[Q+I+10]=l.z,B[Q+I+11]=se.itemSize===4?l.w:1)}}v={count:_,texture:A,size:new mt(H,F)},r.set(p,v),p.addEventListener("dispose",ue)}if(d.isInstancedMesh===!0&&d.morphTexture!==null)m.getUniforms().setValue(s,"morphTexture",d.morphTexture,i);else{let T=0;for(let b=0;b<h.length;b++)T+=h[b];const C=p.morphTargetsRelative?1:1-T;m.getUniforms().setValue(s,"morphTargetBaseInfluence",C),m.getUniforms().setValue(s,"morphTargetInfluences",h)}m.getUniforms().setValue(s,"morphTargetsTexture",v.texture,i),m.getUniforms().setValue(s,"morphTargetsTextureSize",v.size)}return{update:c}}function aE(s,e,i,r,l){let c=new WeakMap;function d(h){const g=l.render.frame,_=h.geometry,v=e.get(h,_);if(c.get(v)!==g&&(e.update(v),c.set(v,g)),h.isInstancedMesh&&(h.hasEventListener("dispose",m)===!1&&h.addEventListener("dispose",m),c.get(h)!==g&&(i.update(h.instanceMatrix,s.ARRAY_BUFFER),h.instanceColor!==null&&i.update(h.instanceColor,s.ARRAY_BUFFER),c.set(h,g))),h.isSkinnedMesh){const M=h.skeleton;c.get(M)!==g&&(M.update(),c.set(M,g))}return v}function p(){c=new WeakMap}function m(h){const g=h.target;g.removeEventListener("dispose",m),r.releaseStatesOfObject(g),i.remove(g.instanceMatrix),g.instanceColor!==null&&i.remove(g.instanceColor)}return{update:d,dispose:p}}const rE={[Gx]:"LINEAR_TONE_MAPPING",[Vx]:"REINHARD_TONE_MAPPING",[kx]:"CINEON_TONE_MAPPING",[jx]:"ACES_FILMIC_TONE_MAPPING",[Xx]:"AGX_TONE_MAPPING",[qx]:"NEUTRAL_TONE_MAPPING",[Wx]:"CUSTOM_TONE_MAPPING"};function sE(s,e,i,r,l){const c=new ji(e,i,{type:s,depthBuffer:r,stencilBuffer:l}),d=new ji(e,i,{type:Sa,depthBuffer:!1,stencilBuffer:!1}),p=new si;p.setAttribute("position",new Bn([-1,3,0,-1,-1,0,3,-1,0],3)),p.setAttribute("uv",new Bn([0,2,0,0,2,0],2));const m=new KS({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            `}),x.jsx("div",{style:{position:"absolute",width:360,height:360,borderRadius:"50%",border:`1px solid ${p.color}18`,animation:"orbit-cw 40s linear infinite"}}),x.jsx("div",{style:{position:"absolute",width:310,height:310,borderRadius:"50%",border:`1px dashed ${p.color}10`,animation:"orbit-ccw 28s linear infinite"}}),x.jsxs("div",{style:{position:"relative",zIndex:10,animation:"capsule-float 4s ease-in-out infinite"},children:[x.jsxs("svg",{width:"90",height:"180",viewBox:"0 0 90 180",fill:"none",children:[x.jsx("path",{d:"M8,90 Q8,8 45,8 Q82,8 82,90 Z",fill:`${p.color}22`,stroke:p.color,strokeWidth:"1"}),x.jsx("path",{d:"M8,90 Q8,172 45,172 Q82,172 82,90 Z",fill:"rgba(255,255,255,0.04)",stroke:`${p.color}55`,strokeWidth:"1"}),x.jsx("path",{d:"M18,44 Q22,22 38,18",stroke:"rgba(255,255,255,0.35)",strokeWidth:"2",strokeLinecap:"round"}),x.jsx("line",{x1:"8",y1:"90",x2:"82",y2:"90",stroke:p.color,strokeWidth:"0.8",strokeOpacity:"0.6"}),x.jsx("text",{x:"45",y:"78",textAnchor:"middle",fill:p.color,fontSize:"11",fontFamily:"serif",fontWeight:"600",letterSpacing:"2",children:"ID"}),x.jsx("text",{x:"45",y:"110",textAnchor:"middle",fill:`${p.color}88`,fontSize:"7",fontFamily:"sans-serif",children:"FORMULA"})]}),x.jsx("div",{style:{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%,-50%)",width:60,height:60,borderRadius:"50%",background:p.color,filter:"blur(28px)",opacity:.2,pointerEvents:"none"}})]}),p.ingredients.map((g,_)=>{const v=g.angle*Math.PI/180,M=Math.cos(v)*g.radius,T=Math.sin(v)*g.radius,C=r===_;return x.jsxs("div",{className:"ing-chip",onMouseEnter:()=>l(_),onMouseLeave:()=>l(null),style:{animationDelay:`${_*.07}s`,position:"absolute",left:`calc(50% + ${M}px)`,top:`calc(50% + ${T}px)`,transform:`translate(-50%, -50%) scale(${C?1.18:1})`,transition:"transform 0.25s cubic-bezier(0.34,1.56,0.64,1), box-shadow 0.25s",background:C?`${p.color}22`:"rgba(255,255,255,0.04)",border:`1px solid ${C?p.color:`${p.color}40`}`,borderRadius:999,padding:"6px 13px",cursor:"pointer",whiteSpace:"nowrap",zIndex:C?20:5,boxShadow:C?`0 0 20px ${p.glow}, 0 0 8px ${p.color}44`:"0 2px 8px rgba(0,0,0,0.3)",backdropFilter:"blur(8px)"},children:[x.jsx("span",{style:{fontSize:"0.88rem"},children:g.emoji}),x.jsx("span",{style:{marginLeft:5,fontSize:"0.68rem",color:C?p.color:s.dim,fontWeight:C?600:400,transition:"color 0.2s"},children:g.name})]},`${c}-${_}`)})]}),x.jsx("div",{style:{minHeight:340},children:h?x.jsxs("div",{style:{opacity:1,transform:"translateY(0)",animation:"ing-pop 0.3s ease forwards"},children:[x.jsx("div",{style:{fontSize:"3rem",marginBottom:16},children:h.emoji}),x.jsx("p",{style:{fontSize:"0.6rem",letterSpacing:"0.22em",textTransform:"uppercase",color:p.color,fontWeight:600,marginBottom:10},children:"Active Ingredient"}),x.jsx("h3",{style:{fontFamily:"serif",fontSize:"clamp(1.4rem,2.5vw,2.2rem)",color:s.white,fontWeight:400,marginBottom:8},children:h.name}),x.jsx("div",{style:{display:"inline-flex",alignItems:"center",gap:6,background:`${p.glow}`,border:`1px solid ${p.color}33`,borderRadius:999,padding:"4px 14px",marginBottom:20},children:x.jsx("span",{style:{fontSize:"0.68rem",color:p.color,fontWeight:600},children:h.benefit})}),x.jsx("p",{style:{fontSize:"0.9rem",color:s.gray,lineHeight:1.8,fontWeight:300,marginBottom:28},children:h.detail}),x.jsxs("div",{children:[x.jsxs("div",{style:{display:"flex",justifyContent:"space-between",marginBottom:8},children:[x.jsx("span",{style:{fontSize:"0.65rem",color:s.dim,letterSpacing:"0.12em",textTransform:"uppercase"},children:"Bioavailability"}),x.jsx("span",{style:{fontSize:"0.65rem",color:p.color,fontWeight:600},children:"High"})]}),x.jsx("div",{style:{height:3,background:"rgba(255,255,255,0.06)",borderRadius:3},children:x.jsx("div",{style:{height:"100%",width:["88%","75%","92%","82%","79%"][r??0%5],background:`linear-gradient(90deg,${p.color},${p.color}66)`,borderRadius:3,boxShadow:`0 0 10px ${p.color}55`,transition:"width 0.6s 0.1s ease"}})})]})]},r):x.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"flex-start",justifyContent:"center",height:"100%",gap:20},children:[x.jsx("div",{style:{fontSize:"3.5rem",opacity:.3},children:"👆"}),x.jsxs("p",{style:{fontFamily:"serif",fontSize:"clamp(1.2rem,2vw,1.7rem)",color:s.dim,fontWeight:400,lineHeight:1.4},children:["Hover an ingredient",x.jsx("br",{}),"to explore its role"]}),x.jsx("div",{style:{display:"flex",flexDirection:"column",gap:12,width:"100%",marginTop:8},children:p.ingredients.map((g,_)=>x.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,opacity:.4+_*.04},children:[x.jsx("span",{style:{width:6,height:6,borderRadius:"50%",background:p.color,flexShrink:0,display:"inline-block"}}),x.jsxs("span",{style:{fontSize:"0.8rem",color:s.dim},children:[g.emoji," ",g.name]})]},_))})]})})]})]})]})}const Go=[{q:"What's your main health goal?",opts:[{label:"⚡ Boost energy & stamina",key:"energy"},{label:"🛡 Strengthen immunity",key:"immunity"},{label:"🧠 Sharpen focus & memory",key:"focus"},{label:"🌙 Improve sleep & recovery",key:"sleep"}]},{q:"How would you describe your current lifestyle?",opts:[{label:"🏃 Very active — gym or sport daily",key:"energy"},{label:"💼 Demanding work schedule, often stressed",key:"focus"},{label:"🍂 Seasonal dips in energy or mood",key:"immunity"},{label:"😴 Poor sleep or frequent fatigue",key:"sleep"}]},{q:"Which matters most to you?",opts:[{label:"⚗️ Highest bioavailability forms",key:"energy"},{label:"🌿 100% natural, zero additives",key:"immunity"},{label:"🔬 Clinically proven ingredients",key:"focus"},{label:"💤 Zero dependency, zero grogginess",key:"sleep"}]}],h2={energy:{title:"Energy Optimizer",icon:"⚡",color:"#CFFFE5",desc:"Your lifestyle calls for sustained, crash-free energy. This formula combines adaptogens and mitochondrial support for all-day performance."},immunity:{title:"Cellular Shield",icon:"🛡",color:"#5eead4",desc:"Your body needs a fortified defence. This stack delivers the highest-absorption forms of key immune modulators."},focus:{title:"Cognitive Nootropic",icon:"🧠",color:"#c4b5fd",desc:"Your focus and memory demand the best. This nootropic stack is built for peak mental performance under pressure."},sleep:{title:"Deep Recovery",icon:"🌙",color:"#fda4af",desc:"Rest is your missing piece. This zero-dependency sleep formula restores deep sleep cycles without morning fog."}};function p2({C:s,onViewFormula:e}){const[i,r]=$e.useState(0),[l,c]=$e.useState({energy:0,immunity:0,focus:0,sleep:0}),[d,p]=$e.useState(!1),[m,h]=$e.useState(!1),g=T=>{const C={...l,[T]:l[T]+1};c(C),i<Go.length-1?(h(!0),setTimeout(()=>{r(b=>b+1),h(!1)},280)):p(!0)},_=Object.entries(l).sort((T,C)=>C[1]-T[1])[0][0],v=h2[_],M=()=>{r(0),c({energy:0,immunity:0,focus:0,sleep:0}),p(!1),h(!1)};return x.jsx("section",{style:{padding:"clamp(60px,8vw,100px) clamp(18px,5vw,56px)",borderTop:`1px solid ${s.border}`,background:`${s.surface}33`},children:x.jsxs("div",{style:{maxWidth:720,margin:"0 auto"},children:[x.jsxs(vi,{style:{textAlign:"center",marginBottom:48},children:[x.jsx("p",{style:{fontSize:"0.65rem",letterSpacing:"0.3em",textTransform:"uppercase",color:s.mint,marginBottom:12,fontWeight:600},children:"Find Your Formula"}),x.jsxs("h2",{style:{fontFamily:"serif",fontSize:"clamp(1.8rem,4vw,3.2rem)",color:s.white,fontWeight:400},children:["Which formula is ",x.jsx("em",{style:{fontStyle:"italic",color:s.mint},children:"right for you?"})]})]}),d?x.jsxs("div",{style:{textAlign:"center"},children:[x.jsx("div",{style:{fontSize:"3.5rem",marginBottom:16},children:v.icon}),x.jsx("p",{style:{fontSize:"0.62rem",letterSpacing:"0.22em",textTransform:"uppercase",color:v.color,fontWeight:600,marginBottom:10},children:"Your Recommendation"}),x.jsx("h3",{style:{fontFamily:"serif",fontSize:"clamp(1.6rem,3vw,2.4rem)",color:s.white,fontWeight:400,marginBottom:16},children:v.title}),x.jsx("p",{style:{fontSize:"0.92rem",color:s.gray,lineHeight:1.8,maxWidth:480,margin:"0 auto 28px",fontWeight:300},children:v.desc}),x.jsxs("div",{style:{display:"flex",justifyContent:"center",gap:12},children:[x.jsx("button",{onClick:()=>e?.(_),style:{background:v.color,color:"#060d0a",border:"none",borderRadius:999,padding:"12px 28px",fontWeight:600,fontSize:"0.84rem",cursor:"pointer"},children:"View Formula →"}),x.jsx("button",{onClick:M,style:{background:"transparent",border:`1px solid ${s.border}`,color:s.dim,borderRadius:999,padding:"12px 28px",fontSize:"0.84rem",cursor:"pointer"},children:"Retake Quiz"})]})]}):x.jsxs("div",{style:{opacity:m?0:1,transform:m?"translateY(16px)":"translateY(0)",transition:"all 0.28s ease"},children:[x.jsx("div",{style:{display:"flex",justifyContent:"center",gap:8,marginBottom:32},children:Go.map((T,C)=>x.jsx("div",{style:{width:C===i?24:8,height:8,borderRadius:999,background:C===i?s.mint:s.border,transition:"all 0.3s"}},C))}),x.jsx("p",{style:{fontFamily:"serif",fontSize:"clamp(1.1rem,2vw,1.5rem)",color:s.white,textAlign:"center",marginBottom:28,fontWeight:400},children:Go[i].q}),x.jsx("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12},children:Go[i].opts.map(T=>x.jsx("button",{onClick:()=>g(T.key),style:{padding:"18px 22px",borderRadius:20,cursor:"pointer",textAlign:"left",background:s.overlay,border:`1px solid ${s.border}`,color:s.gray,fontSize:"0.88rem",fontWeight:400,transition:"all 0.25s",lineHeight:1.4},onMouseEnter:C=>{const b=C.currentTarget;b.style.background="rgba(207,255,229,0.08)",b.style.borderColor=s.mint,b.style.color=s.white,b.style.transform="translateY(-2px)"},onMouseLeave:C=>{const b=C.currentTarget;b.style.background=s.overlay,b.style.borderColor=s.border,b.style.color=s.gray,b.style.transform="none"},children:T.label},T.key))}),x.jsxs("p",{style:{textAlign:"center",fontSize:"0.68rem",color:s.dim,marginTop:20},children:["Step ",i+1," of ",Go.length]})]})]})})}const m2=[{label:"Energy Levels",before:34,after:91,color:"#CFFFE5",timeframe:"After 4 weeks"},{label:"Focus & Clarity",before:41,after:88,color:"#c4b5fd",timeframe:"After 4 weeks"},{label:"Sleep Quality",before:28,after:85,color:"#fda4af",timeframe:"After 2 weeks"},{label:"Immune Resilience",before:45,after:87,color:"#5eead4",timeframe:"After 6 weeks"}];function g2({C:s}){const[e,i]=$e.useState(!1),r=$e.useRef(null);return $e.useEffect(()=>{const l=new IntersectionObserver(([c])=>{c.isIntersecting&&(i(!0),l.disconnect())},{threshold:.3});return r.current&&l.observe(r.current),()=>l.disconnect()},[]),x.jsx("section",{style:{padding:"clamp(60px,8vw,100px) clamp(18px,5vw,56px)",borderTop:`1px solid ${s.border}`},children:x.jsxs("div",{style:{maxWidth:900,margin:"0 auto"},children:[x.jsxs(vi,{style:{textAlign:"center",marginBottom:56},children:[x.jsx("p",{style:{fontSize:"0.65rem",letterSpacing:"0.3em",textTransform:"uppercase",color:s.mint,marginBottom:12,fontWeight:600},children:"Proven Results"}),x.jsxs("h2",{style:{fontFamily:"serif",fontSize:"clamp(1.8rem,4vw,3.2rem)",color:s.white,fontWeight:400},children:["Real outcomes, ",x.jsx("em",{style:{fontStyle:"italic",color:s.mint},children:"measurable change"})]}),x.jsx("p",{style:{fontSize:"0.88rem",color:s.dim,marginTop:14,fontWeight:300},children:"Based on self-reported data from 1,240 Idingo customers over 6 weeks."})]}),x.jsx("div",{ref:r,style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"clamp(20px,4vw,40px)"},className:"hero-grid",children:m2.map((l,c)=>x.jsxs("div",{style:{background:"rgba(255,255,255,0.03)",border:`1px solid ${s.border}`,borderRadius:24,padding:"clamp(20px,3vw,32px)"},children:[x.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"baseline",marginBottom:20},children:[x.jsx("span",{style:{fontSize:"0.88rem",color:s.white,fontWeight:500},children:l.label}),x.jsx("span",{style:{fontSize:"0.62rem",color:s.dim,letterSpacing:"0.1em"},children:l.timeframe})]}),x.jsxs("div",{style:{marginBottom:12},children:[x.jsxs("div",{style:{display:"flex",justifyContent:"space-between",marginBottom:6},children:[x.jsx("span",{style:{fontSize:"0.62rem",color:s.dim,letterSpacing:"0.1em",textTransform:"uppercase"},children:"Before"}),x.jsxs("span",{style:{fontSize:"0.72rem",color:s.dim},children:[l.before,"%"]})]}),x.jsx("div",{style:{height:6,background:"rgba(255,255,255,0.06)",borderRadius:6},children:x.jsx("div",{style:{height:"100%",width:e?`${l.before}%`:"0%",background:"rgba(255,255,255,0.18)",borderRadius:6,transition:`width 1.2s cubic-bezier(.25,.46,.45,.94) ${c*.12}s`}})})]}),x.jsxs("div",{children:[x.jsxs("div",{style:{display:"flex",justifyContent:"space-between",marginBottom:6},children:[x.jsx("span",{style:{fontSize:"0.62rem",color:l.color,letterSpacing:"0.1em",textTransform:"uppercase",fontWeight:600},children:"After"}),x.jsxs("span",{style:{fontSize:"0.72rem",color:l.color,fontWeight:600},children:[l.after,"%"]})]}),x.jsx("div",{style:{height:6,background:"rgba(255,255,255,0.06)",borderRadius:6},children:x.jsx("div",{style:{height:"100%",width:e?`${l.after}%`:"0%",background:`linear-gradient(90deg, ${l.color}, ${l.color}88)`,borderRadius:6,boxShadow:`0 0 12px ${l.color}44`,transition:`width 1.4s cubic-bezier(.25,.46,.45,.94) ${c*.12+.2}s`}})})]}),x.jsx("div",{style:{marginTop:16,display:"inline-flex",alignItems:"center",gap:5,background:`${l.color}12`,border:`1px solid ${l.color}30`,borderRadius:999,padding:"3px 10px"},children:x.jsxs("span",{style:{fontSize:"0.7rem",color:l.color,fontWeight:600},children:["+",l.after-l.before,"% improvement"]})})]},c))})]})})}const x2=[{q:"Are Idingo products vegan and allergen-free?",a:"Yes. Every formula is 100% vegan, gluten-free, and free from common allergens. We use no artificial colours, flavours, or preservatives. Our capsules are made from plant-derived HPMC."},{q:"Where are the ingredients sourced?",a:"We source exclusively from GMP-certified suppliers with full traceability documentation. Patented extracts like KSM-66® Ashwagandha and Ubiquinol CoQ10 are sourced directly from their original manufacturers."},{q:"Are there side effects?",a:"When taken as directed, our formulas are well-tolerated by the vast majority of users. All ingredients are at clinically-studied doses. We recommend consulting your healthcare provider if you are pregnant, nursing, or on medication."},{q:"How long before I notice results?",a:"Many users report improvements in energy and sleep within 7–14 days. For cognitive and immune benefits, 4–6 weeks of consistent use is typically recommended, consistent with clinical research timelines."},{q:"Can I stack multiple formulas?",a:"Yes — we design our formulas with synergistic stacking in mind. Each formula card shows an Optimal Stack partner. Our most popular combination is Energy Optimizer + Cognitive Nootropic."},{q:"What is your money-back policy?",a:"We offer a no-questions-asked 60-day money-back guarantee on every order. If you don't notice a difference, simply contact our team and we will process a full refund — no return required."}];function v2({C:s}){const[e,i]=$e.useState(null);return x.jsx("section",{style:{padding:"clamp(60px,8vw,100px) clamp(18px,5vw,56px)",borderTop:`1px solid ${s.border}`,background:`${s.surface}22`},children:x.jsxs("div",{style:{maxWidth:780,margin:"0 auto"},children:[x.jsxs(vi,{style:{textAlign:"center",marginBottom:52},children:[x.jsx("p",{style:{fontSize:"0.65rem",letterSpacing:"0.3em",textTransform:"uppercase",color:s.mint,marginBottom:12,fontWeight:600},children:"Common Questions"}),x.jsxs("h2",{style:{fontFamily:"serif",fontSize:"clamp(1.8rem,4vw,3.2rem)",color:s.white,fontWeight:400},children:["Frequently Asked ",x.jsx("em",{style:{fontStyle:"italic",color:s.mint},children:"Questions"})]})]}),x.jsx("div",{style:{display:"flex",flexDirection:"column",gap:10},children:x2.map((r,l)=>{const c=e===l;return x.jsxs("div",{onClick:()=>i(c?null:l),style:{background:c?"rgba(207,255,229,0.04)":"rgba(255,255,255,0.02)",border:`1px solid ${c?"rgba(207,255,229,0.2)":s.border}`,borderRadius:18,padding:"0",cursor:"pointer",transition:"all 0.3s",overflow:"hidden"},children:[x.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"18px 22px"},children:[x.jsx("span",{style:{fontSize:"0.9rem",color:c?s.white:s.gray,fontWeight:c?500:400,transition:"color .3s",paddingRight:16},children:r.q}),x.jsx("span",{style:{color:s.mint,fontSize:"1.1rem",flexShrink:0,transition:"transform 0.35s",transform:c?"rotate(45deg)":"rotate(0deg)"},children:"+"})]}),x.jsx("div",{style:{maxHeight:c?200:0,overflow:"hidden",transition:"max-height 0.4s cubic-bezier(0.16,1,0.3,1)"},children:x.jsx("p",{style:{fontSize:"0.86rem",color:s.dim,lineHeight:1.8,fontWeight:300,padding:"0 22px 20px"},children:r.a})})]},l)})})]})})}function _2({C:s}){const e=[{label:"Clinically-studied doses",idingo:!0,typical:!1},{label:"Patented extract forms",idingo:!0,typical:!1},{label:"100% vegan capsules",idingo:!0,typical:!1},{label:"Zero artificial additives",idingo:!0,typical:!1},{label:"Full CoA per batch",idingo:!0,typical:!1},{label:"3rd-party lab verified",idingo:!0,typical:!1},{label:"60-day money-back",idingo:!0,typical:!1},{label:"Proprietary blends used",idingo:!1,typical:!0}];return x.jsx("section",{style:{padding:"clamp(60px,8vw,100px) clamp(18px,5vw,56px)",borderTop:`1px solid ${s.border}`},children:x.jsxs("div",{style:{maxWidth:760,margin:"0 auto"},children:[x.jsxs(vi,{style:{textAlign:"center",marginBottom:48},children:[x.jsx("p",{style:{fontSize:"0.65rem",letterSpacing:"0.3em",textTransform:"uppercase",color:s.mint,marginBottom:12,fontWeight:600},children:"Why Idingo"}),x.jsxs("h2",{style:{fontFamily:"serif",fontSize:"clamp(1.8rem,4vw,3.2rem)",color:s.white,fontWeight:400},children:["Idingo vs ",x.jsx("em",{style:{fontStyle:"italic",color:"#fda4af"},children:"Typical Supplements"})]})]}),x.jsxs("div",{style:{background:"rgba(255,255,255,0.02)",border:`1px solid ${s.border}`,borderRadius:24,overflow:"hidden"},children:[x.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 160px 160px",background:"rgba(255,255,255,0.04)",padding:"14px 24px",borderBottom:`1px solid ${s.border}`},children:[x.jsx("span",{style:{fontSize:"0.65rem",letterSpacing:"0.15em",textTransform:"uppercase",color:s.dim},children:"Feature"}),x.jsx("span",{style:{fontSize:"0.72rem",fontWeight:600,color:s.mint,textAlign:"center"},children:"🌿 Idingo"}),x.jsx("span",{style:{fontSize:"0.72rem",fontWeight:500,color:s.dim,textAlign:"center"},children:"Generic Brand"})]}),e.map((i,r)=>x.jsx(vi,{delay:r*.06,children:x.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 160px 160px",padding:"14px 24px",borderBottom:r<e.length-1?`1px solid ${s.border}`:"none",transition:"background 0.2s"},onMouseEnter:l=>l.currentTarget.style.background="rgba(255,255,255,0.02)",onMouseLeave:l=>l.currentTarget.style.background="transparent",children:[x.jsx("span",{style:{fontSize:"0.84rem",color:s.gray,fontWeight:300},children:i.label}),x.jsx("div",{style:{textAlign:"center"},children:i.idingo?x.jsx("span",{style:{color:s.mint,fontSize:"1rem",filter:"drop-shadow(0 0 6px rgba(207,255,229,0.5))"},children:"✓"}):x.jsx("span",{style:{color:"#fda4af",fontSize:"1rem",opacity:.7},children:"✗"})}),x.jsx("div",{style:{textAlign:"center"},children:i.typical?x.jsx("span",{style:{color:s.mint,fontSize:"1rem"},children:"✓"}):x.jsx("span",{style:{color:"rgba(255,255,255,0.2)",fontSize:"1rem"},children:"✗"})})]})},r))]})]})})}function y2({C:s}){const e=x.jsxs(x.Fragment,{children:[x.jsx("p",{style:{fontSize:"0.7rem",letterSpacing:"0.2em",textTransform:"uppercase",color:"#CFFFE5",fontWeight:600},children:"By The Numbers"}),[["12,000+","Studies reviewed"],["340+","Compounds tested"],["18","Formulas active"],["99.7%","Batch pass rate"]].map(([i,r])=>x.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"baseline",borderBottom:"1px solid rgba(255,255,255,0.07)",paddingBottom:8},children:[x.jsx("span",{style:{fontFamily:"serif",fontSize:"1.6rem",color:"#CFFFE5"},children:i}),x.jsx("span",{style:{fontSize:"0.78rem",color:"rgba(255,255,255,0.4)",fontWeight:300},children:r})]},r)),x.jsx("p",{style:{fontSize:"0.7rem",color:"rgba(255,255,255,0.3)",marginTop:4},children:"Click to flip back"})]});return x.jsx("section",{style:{padding:"clamp(60px,8vw,100px) clamp(18px,5vw,56px)"},children:x.jsxs("div",{style:{maxWidth:1160,margin:"0 auto"},children:[x.jsxs(vi,{style:{textAlign:"center",marginBottom:48},children:[x.jsx("p",{style:{fontSize:"0.65rem",letterSpacing:"0.3em",textTransform:"uppercase",color:s.mint,marginBottom:12,fontWeight:600},children:"Our Standard"}),x.jsxs("h2",{style:{fontFamily:"serif",fontSize:"clamp(1.8rem,4vw,3.2rem)",color:s.white,fontWeight:400},children:["The Idingo ",x.jsx("em",{style:{fontStyle:"italic"},children:"Difference"})]})]}),x.jsxs(vi,{delay:.1,children:[x.jsxs("div",{className:"bento-desktop",style:{display:"grid",gridTemplateColumns:"2fr 1.2fr 1fr",gridTemplateRows:"auto auto",gap:24},children:[x.jsxs(Ds,{style:{gridColumn:"span 2",gridRow:"span 2"},p:"56px 48px",flip:!0,flipBack:e,C:s,children:[x.jsx("div",{style:{fontSize:"1.8rem",marginBottom:22},children:"🔬"}),x.jsxs("h3",{style:{fontFamily:"serif",fontSize:"clamp(1.4rem,2.5vw,2rem)",color:s.white,marginBottom:14,fontWeight:400,lineHeight:1.2},children:["Research &",x.jsx("br",{}),"Development"]}),x.jsx("p",{style:{fontSize:"0.9rem",color:s.gray,lineHeight:1.8,fontWeight:300,maxWidth:380},children:"We review thousands of peer-reviewed studies to select only compounds with clinically demonstrated efficacy. No ingredient enters our formulas without data to back it."}),x.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:8,marginTop:28},children:["Peer-reviewed","Clinical Trials","Bioavailability-optimised"].map(i=>x.jsx("span",{style:{fontSize:"0.62rem",border:`1px solid ${s.borderHi}`,color:s.mint,borderRadius:999,padding:"4px 12px"},children:i},i))}),x.jsx("p",{style:{fontSize:"0.68rem",color:s.dim,marginTop:20},children:"Click card to see stats →"})]}),x.jsxs(Ds,{p:"30px 26px",C:s,children:[x.jsxs("div",{style:{display:"flex",justifyContent:"space-between",marginBottom:14},children:[x.jsx("span",{style:{color:s.white,fontSize:"0.9rem",fontWeight:500},children:"Safety & Efficacy"}),x.jsx("span",{style:{color:s.teal},children:"🛡"})]}),x.jsxs("div",{style:{fontFamily:"serif",fontSize:"3rem",color:s.white,lineHeight:1},children:["100",x.jsx("span",{style:{color:s.mint,fontSize:"1.6rem"},children:"%"})]}),x.jsx("p",{style:{fontSize:"0.75rem",color:s.dim,marginTop:8,fontWeight:300},children:"External testing every batch"})]}),x.jsxs(Ds,{p:"30px 26px",style:{position:"relative"},C:s,children:[x.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:10},children:[x.jsx("div",{style:{fontSize:"1.3rem"},children:"↩"}),x.jsx("div",{style:{display:"flex",gap:2},children:[1,2,3,4,5].map(i=>x.jsx("span",{style:{color:"#CFFFE5",fontSize:"0.7rem"},children:"★"},i))})]}),x.jsx("h3",{style:{color:s.white,fontSize:"0.9rem",fontWeight:500,marginBottom:6},children:"Full Guarantee"}),x.jsx("p",{style:{fontSize:"0.75rem",color:s.dim,fontWeight:300,lineHeight:1.6,marginBottom:10},children:"Money-back, no questions asked on every formula."}),x.jsxs("div",{style:{display:"flex",alignItems:"center",gap:6,padding:"5px 10px",borderRadius:999,background:"rgba(207,255,229,0.06)",border:"1px solid rgba(207,255,229,0.12)",width:"fit-content"},children:[x.jsx("span",{style:{width:5,height:5,borderRadius:"50%",background:"#CFFFE5",display:"inline-block"}}),x.jsx("span",{style:{fontSize:"0.6rem",color:s.mint,letterSpacing:"0.08em"},children:"12,400+ satisfied customers"})]})]}),x.jsxs(Ds,{p:"30px 26px",C:s,children:[x.jsxs("div",{style:{fontFamily:"serif",fontSize:"2.8rem",color:s.mint,lineHeight:1},children:["0",x.jsx("span",{style:{fontSize:"1.3rem"},children:"%"})]}),x.jsx("p",{style:{fontSize:"0.75rem",color:s.dim,marginTop:8,fontWeight:300},children:"Additives · Preservatives · Hormones"}),x.jsx("h3",{style:{color:s.white,fontSize:"0.88rem",fontWeight:500,marginTop:10},children:"🌿 Pure Formula"})]}),x.jsxs(Ds,{p:"30px 26px",C:s,children:[x.jsx("div",{style:{fontSize:"1.5rem",marginBottom:12},children:"📋"}),x.jsx("h3",{style:{color:s.white,fontSize:"0.9rem",fontWeight:500,marginBottom:8},children:"Transparency"}),x.jsx("p",{style:{fontSize:"0.75rem",color:s.dim,fontWeight:300,lineHeight:1.65},children:"CoA available for every single batch on request."})]})]}),x.jsx("div",{className:"bento-mobile",style:{display:"none",flexDirection:"column",gap:14},children:[{icon:"🔬",title:"Research & Development",desc:"We review thousands of peer-reviewed studies. Every ingredient is backed by data."},{icon:"🛡",title:"100% Safety Tested",desc:"External third-party testing on every single batch we produce."},{icon:"↩",title:"Full Guarantee",desc:"Money-back, no questions asked on every formula."},{icon:"🌿",title:"0% Additives",desc:"Zero preservatives, hormones or additives. Ever."},{icon:"📋",title:"Transparent",desc:"Certificate of Analysis available for every batch on request."}].map(i=>x.jsxs(Ds,{p:"28px 24px",C:s,children:[x.jsx("div",{style:{fontSize:"1.4rem",marginBottom:12},children:i.icon}),x.jsx("h3",{style:{color:s.white,fontSize:"1rem",fontWeight:500,marginBottom:8},children:i.title}),x.jsx("p",{style:{fontSize:"0.84rem",color:s.dim,fontWeight:300,lineHeight:1.65},children:i.desc})]},i.title))})]})]})})}function S2({C:s}){const[e,i]=$e.useState(0),[r,l]=$e.useState(null),c=$e.useRef(null),d=[{n:"01",icon:"🔬",title:"Research",desc:"Sourcing only compounds backed by robust peer-reviewed data.",detail:"Our science team reviews 100+ studies per ingredient. Only compounds with at least 3 randomized controlled trials make the cut.",facts:["12,000+ papers reviewed","Zero proprietary blends","Efficacy over popularity"]},{n:"02",icon:"⚗️",title:"Formulation",desc:"Synergistic blends engineered for maximum bioavailability.",detail:"We engineer ratios based on pharmacokinetic data. Every pairing is tested for synergistic or antagonistic interactions before approval.",facts:["4:1 Theanine:Caffeine ratio","Liposomal delivery tech","Form-specific sourcing"]},{n:"03",icon:"🏭",title:"Manufacturing",desc:"GMP-certified facility in Oklahoma City, OK.",detail:"Our FDA-registered facility operates under full chain-of-custody traceability from raw material to sealed capsule.",facts:["NSF GMP Certified","HACCP compliant","Full CoA per batch"]},{n:"04",icon:"🌍",title:"Distribution",desc:"Shipped from Norcross, GA warehouse worldwide.",detail:"Climate-controlled storage preserves potency from warehouse to doorstep. Every shipment includes a batch QR code.",facts:["24–48hr fulfillment","Cold-chain logistics","Batch QR traceability"]}];return $e.useEffect(()=>{const p=new IntersectionObserver(([m])=>{m.isIntersecting&&i(100)},{threshold:.3});return c.current&&p.observe(c.current),()=>p.disconnect()},[]),x.jsx("section",{style:{padding:"clamp(60px,8vw,100px) clamp(18px,5vw,56px)",borderTop:`1px solid ${s.border}`},children:x.jsxs("div",{style:{maxWidth:1160,margin:"0 auto"},children:[x.jsx(vi,{style:{textAlign:"center",marginBottom:68},children:x.jsxs("h2",{style:{fontFamily:"serif",fontSize:"clamp(1.8rem,4vw,3.2rem)",color:s.white,fontWeight:400},children:["The Formulation ",x.jsx("em",{style:{fontStyle:"italic",color:s.mint},children:"Journey"})]})}),x.jsxs("div",{ref:c,style:{position:"relative"},children:[x.jsx("style",{children:`
          ...
          `}),x.jsx("div",{className:"timeline-connector",style:{position:"absolute",top:30,left:"12.5%",right:"12.5%",height:1,background:s.border},children:x.jsx("div",{style:{height:"100%",width:`${e}%`,background:`linear-gradient(to right, ${s.mint}, ${s.teal})`,transition:"all 1.5s cubic-bezier(.25,.46,.45,.94)",boxShadow:"0 0 8px rgba(207,255,229,0.4)"}})}),x.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:"clamp(14px,3vw,32px)"},className:"timeline-grid",children:d.map((p,m)=>{const h=r===m;return x.jsxs(vi,{delay:m*.12,style:{textAlign:"center"},className:"timeline-reveal",children:[x.jsx("div",{onClick:()=>l(h?null:m),className:"timeline-step-icon",style:{width:60,height:60,borderRadius:"50%",background:h?"rgba(207,255,229,0.08)":s.bg,border:`1px solid ${h?s.mint:s.border}`,display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 22px",position:"relative",zIndex:2,boxShadow:h?"0 0 24px rgba(207,255,229,0.2)":"0 0 24px rgba(0,0,0,0.7)",transition:"all .3s",cursor:"pointer"},children:x.jsx("span",{style:{fontSize:h?"1.4rem":"1.1rem",fontFamily:"serif",color:h?s.mint:s.dim,transition:"all .3s"},children:h?p.icon:p.n})}),x.jsx("h4",{onClick:()=>l(h?null:m),style:{color:h?s.mint:s.white,fontSize:"0.98rem",fontWeight:500,marginBottom:8,cursor:"pointer",transition:"color .3s"},children:p.title}),x.jsx("p",{style:{fontSize:"0.8rem",color:s.dim,lineHeight:1.65,fontWeight:300},children:p.desc}),x.jsx("div",{style:{overflow:"hidden",maxHeight:h?240:0,transition:"max-height 0.45s cubic-bezier(0.16,1,0.3,1)",marginTop:h?14:0},children:x.jsxs("div",{style:{background:"rgba(207,255,229,0.04)",border:"1px solid rgba(207,255,229,0.1)",borderRadius:14,padding:"14px 16px",textAlign:"left"},children:[x.jsx("p",{style:{fontSize:"0.78rem",color:s.gray,lineHeight:1.7,marginBottom:12},children:p.detail}),p.facts.map((g,_)=>x.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8,marginBottom:5},children:[x.jsx("span",{style:{color:s.mint,fontSize:"0.65rem"},children:"✓"}),x.jsx("span",{style:{fontSize:"0.72rem",color:s.dim},children:g})]},_))]})}),x.jsx("p",{onClick:()=>l(h?null:m),style:{fontSize:"0.58rem",color:s.dim,marginTop:8,opacity:.45,cursor:"pointer"},children:h?"▲ collapse":"▼ details"})]},m)})})]})]})})}function b2({active:s}){const e=$e.useMemo(()=>Array.from({length:40},(i,r)=>({id:r,x:Math.random()*100,vx:(Math.random()-.5)*4,vy:-Math.random()*6-4,color:["#CFFFE5","#5eead4","#fda4af","#c4b5fd","#fff"][r%5],r:Math.random()*6+3,rot:Math.random()*360})),[]);return s?x.jsxs("div",{style:{position:"fixed",inset:0,pointerEvents:"none",zIndex:500},children:[x.jsx("style",{children:"@keyframes cfti{0%{transform:translateY(0) rotate(0deg);opacity:1}100%{transform:translateY(120vh) rotate(720deg);opacity:0}}"}),e.map(i=>x.jsx("div",{style:{position:"absolute",left:`${i.x}%`,top:"20%",width:i.r,height:i.r*1.6,background:i.color,borderRadius:2,animation:`cfti ${1.5+Math.random()*1.2}s ease-in ${Math.random()*.5}s forwards`,transform:`rotate(${i.rot}deg)`}},i.id))]}):null}function M2({C:s,onNavigate:e}){const[i,r]=$e.useState(!1),[l,c]=$e.useState(!1),[d,p]=$e.useState(""),m=()=>{d&&(r(!0),c(!0),setTimeout(()=>c(!1),2500))};return x.jsxs(x.Fragment,{children:[x.jsx(b2,{active:l}),x.jsx("footer",{style:{borderTop:`1px solid ${s.border}`,padding:"clamp(40px,6vw,68px) clamp(18px,5vw,56px) 26px",background:s.bg},children:x.jsxs("div",{style:{maxWidth:1160,margin:"0 auto"},children:[x.jsxs("div",{style:{display:"grid",gridTemplateColumns:"2fr 1fr 1fr",gap:"clamp(28px,5vw,68px)",marginBottom:44},className:"footer-grid",children:[x.jsxs("div",{children:[x.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8,marginBottom:14},children:[x.jsx("span",{children:"🌿"}),x.jsx("span",{style:{fontFamily:"serif",fontSize:"1.35rem",color:s.white,letterSpacing:"0.1em"},children:"Idingo."})]}),x.jsx("p",{style:{fontSize:"0.83rem",color:s.dim,lineHeight:1.75,maxWidth:300,fontWeight:300,marginBottom:26},children:"Optimize health naturally. Premium nutraceuticals grounded in science since 2008."}),i?x.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8,color:s.mint,fontSize:"0.88rem"},children:[x.jsx("span",{style:{fontSize:"1.2rem"},children:"🎉"})," You're in! Welcome to Idingo."]}):x.jsxs("div",{style:{display:"flex",gap:10,flexWrap:"wrap"},children:[x.jsx("input",{value:d,onChange:h=>p(h.target.value),placeholder:"Your email",onFocus:h=>{h.target.style.borderColor="rgba(207,255,229,0.45)",h.target.style.boxShadow="0 0 0 3px rgba(207,255,229,0.08)"},onBlur:h=>{h.target.style.borderColor=s.border,h.target.style.boxShadow="none"},style:{background:"rgba(255,255,255,0.05)",border:`1px solid ${s.border}`,borderRadius:8,padding:"10px 14px",color:s.white,fontSize:"0.8rem",outline:"none",width:185,transition:"border-color .25s, box-shadow .25s"}}),x.jsx("button",{onClick:m,style:{background:s.mint,color:"#060d0a",border:"none",borderRadius:8,padding:"10px 16px",fontWeight:600,fontSize:"0.76rem",cursor:"pointer",transition:"all .2s"},onMouseEnter:h=>{h.currentTarget.style.boxShadow="0 0 20px rgba(207,255,229,0.4)"},onMouseLeave:h=>{h.currentTarget.style.boxShadow="none"},children:"Subscribe →"})]})]}),x.jsxs("div",{children:[x.jsx("h5",{style:{color:s.white,fontWeight:500,marginBottom:16,fontSize:"0.86rem"},children:"Locations"}),[["HQ","Boynton Beach, FL"],["Warehouse","Norcross, GA"],["Manufacturing","Oklahoma City, OK"]].map(([h,g])=>x.jsxs("div",{style:{marginBottom:9},children:[x.jsxs("span",{style:{fontSize:"0.62rem",color:s.mint,letterSpacing:"0.1em",textTransform:"uppercase"},children:[h,": "]}),x.jsx("span",{style:{fontSize:"0.8rem",color:s.dim,fontWeight:300},children:g})]},h))]}),x.jsxs("div",{children:[x.jsx("h5",{style:{color:s.white,fontWeight:500,marginBottom:16,fontSize:"0.86rem"},children:"Company"}),[{label:"About Idingo",page:"about"},{label:"Our Process",page:"process"},{label:"Gallery",page:"gallery"},{label:"Contact",page:"contact"}].map(h=>x.jsx("div",{onClick:()=>{e(h.page),window.scrollTo({top:0,behavior:"smooth"})},style:{marginBottom:9,fontSize:"0.83rem",color:s.dim,cursor:"pointer",fontWeight:300,transition:"color .2s"},onMouseEnter:g=>g.currentTarget.style.color=s.mint,onMouseLeave:g=>g.currentTarget.style.color=s.dim,children:h.label},h.label))]})]}),x.jsxs("div",{style:{borderTop:`1px solid ${s.border}`,paddingTop:20,display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:10},children:[x.jsx("span",{style:{fontSize:"0.7rem",color:s.dim},children:"© 2026 Idingo LLC. All rights reserved."}),x.jsx("span",{style:{fontSize:"0.62rem",color:s.dim,letterSpacing:"0.18em",textTransform:"uppercase"},children:"Est. 2008"})]})]})})]})}function E2(){const[s,e]=$e.useState("home"),[i,r]=$e.useState(null),[l,c]=$e.useState(!1),d=a2;$e.useEffect(()=>{const m=()=>c(window.scrollY>48);return window.addEventListener("scroll",m,{passive:!0}),()=>window.removeEventListener("scroll",m)},[]);const p=()=>{switch(s){case"about":return x.jsx(e2,{C:d});case"process":return x.jsx(t2,{C:d});case"gallery":return x.jsx(n2,{C:d});case"contact":return x.jsx(i2,{C:d});default:return null}};return x.jsxs("div",{style:{background:d.bg,color:d.white,fontFamily:"'Inter','Helvetica Neue',sans-serif",overflowX:"hidden",lineHeight:1.5},children:[x.jsx("style",{children:`
      ...
      `}),x.jsx(o2,{}),x.jsx("div",{style:{position:"fixed",top:"-5%",left:"-8%",width:"44vw",height:"44vw",background:"rgba(207,255,229,0.032)",borderRadius:"50%",filter:"blur(110px)",pointerEvents:"none",zIndex:0,animation:"ambg 14s ease-in-out infinite"}}),x.jsx("div",{style:{position:"fixed",bottom:"-8%",right:"-8%",width:"34vw",height:"34vw",background:"rgba(94,234,212,0.022)",borderRadius:"50%",filter:"blur(90px)",pointerEvents:"none",zIndex:0,animation:"ambg 18s ease-in-out 5s infinite reverse"}}),x.jsx("div",{style:{position:"fixed",inset:0,backgroundImage:`url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.85' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23n)'/%3E%3C/svg%3E")`,opacity:.04,pointerEvents:"none",zIndex:1,mixBlendMode:"overlay"}}),x.jsx("div",{style:{position:"fixed",inset:0,background:"radial-gradient(circle at 50% 0%, rgba(207,255,229,0.05) 0%, transparent 60%)",pointerEvents:"none",zIndex:1}}),x.jsx(c2,{scrolled:l,C:d,currentPage:s,onNavigate:e}),s==="home"?x.jsxs(x.Fragment,{children:[x.jsxs("section",{style:{minHeight:"100vh",display:"flex",flexDirection:"column",position:"relative",overflow:"hidden",paddingTop:80},children:[x.jsx("div",{style:{position:"absolute",inset:0},children:x.jsx(s2,{})}),x.jsx("div",{style:{flex:1,display:"flex",alignItems:"center",maxWidth:1160,margin:"0 auto",padding:"clamp(28px,5vw,60px) clamp(18px,5vw,56px)",width:"100%",position:"relative",zIndex:2},children:x.jsxs("div",{className:"hero-grid",style:{width:"100%"},children:[x.jsxs("div",{children:[x.jsxs("div",{style:{display:"inline-flex",alignItems:"center",gap:8,background:"rgba(207,255,229,0.07)",border:"1px solid rgba(207,255,229,0.18)",borderRadius:999,padding:"5px 14px",marginBottom:26},children:[x.jsx("span",{style:{width:6,height:6,borderRadius:"50%",background:d.mint,display:"inline-block",animation:"pulseglow 2.5s ease-in-out infinite"}}),x.jsx("span",{style:{fontSize:"0.62rem",letterSpacing:"0.25em",textTransform:"uppercase",color:d.mint,fontWeight:600},children:"Crafted in the Lab · Est. 2008"})]}),x.jsxs("h1",{style:{fontFamily:"'Playfair Display',serif",fontSize:"clamp(2.6rem,6vw,5.5rem)",color:d.white,lineHeight:1.06,fontWeight:400,marginBottom:22},children:["Your health.",x.jsx("br",{}),x.jsx("em",{style:{fontStyle:"italic",background:`linear-gradient(90deg,${d.mint},${d.teal})`,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",animation:"shimmer 3s ease-in-out infinite"},children:"Optimised"}),x.jsx("br",{}),"by science."]}),x.jsx("p",{style:{fontSize:"clamp(0.88rem,1.4vw,1rem)",color:d.gray,lineHeight:1.8,fontWeight:300,maxWidth:400,marginBottom:36},children:"Premium nutraceuticals. Vegan, organic, 100% pure. Zero compromises on quality, purity, or transparency."}),x.jsxs("div",{style:{display:"flex",gap:12,flexWrap:"wrap"},children:[x.jsx("button",{onClick:()=>document.getElementById("lab")?.scrollIntoView({behavior:"smooth"}),style:{background:d.mint,color:"#060d0a",border:"none",borderRadius:999,padding:"14px clamp(22px,3vw,38px)",fontWeight:600,fontSize:"0.86rem",cursor:"pointer",transition:"all .3s",boxShadow:"0 0 0 rgba(207,255,229,0)"},onMouseEnter:m=>{const h=m.currentTarget;h.style.boxShadow="0 0 28px rgba(207,255,229,0.35)",h.style.transform="translateY(-2px)"},onMouseLeave:m=>{const h=m.currentTarget;h.style.boxShadow="none",h.style.transform="translateY(0)"},children:"Explore Formulas 🧪"}),x.jsx("button",{onClick:()=>e("process"),style:{background:d.overlay,color:d.white,border:`1px solid ${d.overlayBorder}`,borderRadius:999,padding:"14px clamp(22px,3vw,38px)",fontWeight:400,fontSize:"0.86rem",cursor:"pointer",transition:"background .3s"},onMouseEnter:m=>m.currentTarget.style.background=d.overlayHover,onMouseLeave:m=>m.currentTarget.style.background=d.overlay,children:"📖 Science Basis"})]}),x.jsx("div",{style:{display:"flex",gap:16,marginTop:36,flexWrap:"wrap"},children:["✓ 100% Organic","✓ 3rd Party Tested","✓ Vegan Certified"].map(m=>x.jsx("span",{style:{fontSize:"0.68rem",color:"rgba(207,255,229,0.55)",letterSpacing:"0.04em",fontWeight:500},children:m},m))})]}),x.jsxs("div",{className:"hero-bottle-col",style:{position:"relative",height:"clamp(360px,50vw,580px)",display:"flex",alignItems:"center",justifyContent:"center"},children:[x.jsx("div",{style:{position:"absolute",width:"68%",aspectRatio:"1",border:"1px solid rgba(207,255,229,0.07)",borderRadius:"50%",animation:"spincw 22s linear infinite",top:"50%",left:"50%",transform:"translate(-50%,-50%)"}}),x.jsx("div",{style:{position:"absolute",width:"88%",aspectRatio:"1",border:"1px solid rgba(255,255,255,0.03)",borderRadius:"50%",animation:"spinccw 34s linear infinite",top:"50%",left:"50%",transform:"translate(-50%,-50%)"}}),x.jsx("div",{style:{position:"absolute",width:"48%",aspectRatio:"1",background:"radial-gradient(circle,rgba(207,255,229,0.07),transparent 70%)",borderRadius:"50%",filter:"blur(18px)",top:"50%",left:"50%",transform:"translate(-50%,-50%)",pointerEvents:"none"}}),x.jsx("div",{style:{width:"100%",height:"100%",position:"relative",zIndex:2},children:x.jsx(r2,{})}),x.jsx("div",{style:{position:"absolute",top:"12%",right:"3%",background:d.surface,backdropFilter:"blur(14px)",border:`1px solid ${d.borderHi}`,borderRadius:12,padding:"8px 13px",fontSize:"0.68rem",color:d.mint,whiteSpace:"nowrap",zIndex:3},children:"✓ 100% Organic"}),x.jsx("div",{style:{position:"absolute",bottom:"20%",left:"1%",background:d.surface,backdropFilter:"blur(14px)",border:`1px solid ${d.border}`,borderRadius:12,padding:"8px 13px",fontSize:"0.68rem",color:d.gray,whiteSpace:"nowrap",zIndex:3},children:"🛡 Clinically Validated"})]})]})}),x.jsx(l2,{C:d})]}),x.jsx("div",{style:{background:d.surface,borderTop:`1px solid ${d.border}`,borderBottom:`1px solid ${d.border}`},children:x.jsx("div",{style:{maxWidth:1160,margin:"0 auto",display:"grid",gridTemplateColumns:"repeat(4,1fr)"},className:"timeline-grid",children:[["16+","Years Research"],["100%","Vegan & Organic"],["3rd","Party Lab Tested"],["0","Additives"]].map(([m,h],g)=>x.jsx(vi,{delay:g*.08,children:x.jsxs("div",{style:{padding:"clamp(18px,3vw,28px) 12px",borderRight:`1px solid ${d.border}`,textAlign:"center"},children:[x.jsx("div",{style:{fontFamily:"serif",fontSize:"clamp(1.8rem,3.5vw,2.8rem)",color:d.mint,lineHeight:1},children:m}),x.jsx("div",{style:{fontSize:"0.62rem",letterSpacing:"0.15em",textTransform:"uppercase",color:d.dim,marginTop:7},children:h})]})},h))})}),x.jsx("div",{id:"quiz",children:x.jsx(p2,{C:d,onViewFormula:r})}),x.jsx(g2,{C:d}),x.jsx(y2,{C:d}),x.jsx(d2,{C:d}),x.jsx("div",{id:"lab",children:x.jsx(f2,{C:d,onViewFormula:r})}),x.jsx(_2,{C:d}),x.jsx(v2,{C:d}),x.jsx(S2,{C:d})]}):p(),x.jsx(u2,{formulaKey:i,onClose:()=>r(null),C:d}),x.jsx(M2,{C:d,onNavigate:e})]})}Py.createRoot(document.getElementById("root")).render(x.jsx(E2,{}));
